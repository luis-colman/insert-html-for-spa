...
3. Copy the content of the file "**_config.json"_**" of the repository [Insert HTML for SPA](https://github.com/luis-colman/insert-html-for-spa/blob/master/config.json).
